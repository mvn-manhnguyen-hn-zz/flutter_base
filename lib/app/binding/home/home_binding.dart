...
import 'package:flutter_base/data/network/repositories/invoice_repository.dart';
...
class HomeBinding extends Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut<InvoiceInterface>(() => InvoiceRepository(dio: Get.find()));
    Get.lazyPut(() => HomeController(
        shopInterface: Get.find(),
        rankTopInterface: Get.find(),
        profileInterface: Get.find(),
      invoiceInterface: Get.find()
    ));
  }
}
